...
internal class Unit_0007 : Character
{
    public Unit_0007(UnitParameters config, Team team, CharacterConfigReader pathConfig, Battle battle) : base(config, pathConfig, team, battle)
    {
