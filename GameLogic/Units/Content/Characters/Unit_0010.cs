...
internal class Unit_0010 : Character
{
    public Unit_0010(UnitParameters config, Team team, CharacterConfigReader pathConfig, Battle battle) : base(config, pathConfig, team, battle)
    {
