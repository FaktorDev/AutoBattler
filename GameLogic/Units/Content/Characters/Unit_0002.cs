...
internal class Unit_0002 : Character
{
    public Unit_0002(UnitParameters config, Team team, CharacterConfigReader pathConfig, Battle battle) : base(config, pathConfig, team, battle)
    {
