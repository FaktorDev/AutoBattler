...
internal class Unit_0001 : Character
{
    public Unit_0001(UnitParameters config, Team team, CharacterConfigReader pathConfig, Battle battle) : base(config, pathConfig, team, battle)
    {
