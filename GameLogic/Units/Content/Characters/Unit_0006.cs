...
internal class Unit_0006 : Character
{
    public Unit_0006(UnitParameters config, Team team, CharacterConfigReader pathConfig, Battle battle) : base(config, pathConfig, team, battle)
    {
